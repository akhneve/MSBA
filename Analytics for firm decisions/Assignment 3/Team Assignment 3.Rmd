...
+===============+===============+=============+==============+===========+
| Tide 128 oz   |   0.568       |   8.363     |   8.476      |  0.760    |
+---------------+---------------+-------------+--------------+-----------+
| Tide 64 oz    |   0.263       |   4.375     |   4.419      |  0.404    |
+---------------+---------------+-------------+--------------+-----------+
| Wisk 64 oz    |   0.168       |   4.071     |   4.19       |  0.490    |
+---------------+---------------+-------------+--------------+-----------+
...
+============================+=============+=============+==============+
| Tide 128 oz & Tide 64 oz   |    3.987    |   4.094     |   0.870      |
+----------------------------+-------------+-------------+--------------+
| Tide 64 oz & Wisk 64 oz    |    0.303    |   0.260     |   0.585      |
+----------------------------+-------------+-------------+--------------+

Histograms of the price gaps
```{r}
hist(detergent_DF$p_gap_tide128_64, 
     main='Price Gap between Tide 128 oz & Tide 64 oz',
     xlab='Price Gap ($)',
     col='darkmagenta')

hist(detergent_DF$p_gap_tide64_wisk64, 
     main='Price Gap between Tide 64 oz & Wisk 64 oz',
     xlab='Price Gap ($)',
     col='cyan2')
```

According to the first histogram, We observe that there is enough variation of the price gap between Tide 128oz and Tide 64oz as there are histogram bars spread away from the mean.  
According to the second histogram, there is not enough variation of the price gap between Tide 128oz and Tide 64oz, as the histogram bars are less spread away from the mean.
